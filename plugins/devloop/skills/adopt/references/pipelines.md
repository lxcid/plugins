...
- Before implementing, list the binding decisions from earlier pipelines with the command in the README's spec section. They constrain your work even though another pipeline made them, unless a later `Overturns:` line names them.
